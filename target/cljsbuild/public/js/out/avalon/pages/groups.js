...
goog.provide('avalon.pages.groups');
goog.require('cljs.core');
goog.require('reagent.core');
goog.require('reagent.session');
goog.require('material_ui.core');
goog.require('accountant.core');
avalon.pages.groups.group = (function avalon$pages$groups$group(){
...
return (function avalon$pages$groups$group_$_iter__30854(s__30855){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__30857),avalon$pages$groups$group_$_iter__30854.call(null,cljs.core.chunk_rest.call(null,s__30855__$2)));
} else {
...
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.player","div.player",8830217),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(person)], null),avalon$pages$groups$group_$_iter__30854.call(null,cljs.core.rest.call(null,s__30855__$2)));
}
} else {
return null;
}
