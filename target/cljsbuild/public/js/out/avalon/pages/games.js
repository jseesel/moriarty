...
goog.provide('avalon.pages.games');
...
avalon.pages.games.handle_error = (function avalon$pages$games$handle_error(p__24469){
...
return reagent.session.put_BANG_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),avalon.utils.capitalize.call(null,cljs.core.first.call(null,cljs.core.val.call(null,cljs.core.first.call(null,response)))));
} else {
...
avalon.pages.games.get_game_BANG_ = (function avalon$pages$games$get_game_BANG_(var_args){
...
return avalon.pages.games.get_game_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21565__auto__);
});

avalon.pages.games.get_game_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (id,p__24483){
...
avalon.pages.games.get_game_BANG_.cljs$lang$maxFixedArity = (1);

avalon.pages.games.get_game_BANG_.cljs$lang$applyTo = (function (seq24481){
var G__24482 = cljs.core.first.call(null,seq24481);
var seq24481__$1 = cljs.core.next.call(null,seq24481);
return avalon.pages.games.get_game_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__24482,seq24481__$1);
});
avalon.pages.games.get_info_BANG_ = (function avalon$pages$games$get_info_BANG_(id,person_id){
...
avalon.pages.games.delete_player_BANG_ = (function avalon$pages$games$delete_player_BANG_(id,name){
...
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),avalon.pages.games.handle_error], null));
});
avalon.pages.games.toggle_role_BANG_ = (function avalon$pages$games$toggle_role_BANG_(id,role,on){
...
avalon.pages.games.role_toggle = (function avalon$pages$games$role_toggle(id,roles,role){
...
return (function (){
return avalon.pages.games.toggle_role_BANG_.call(null,id,role,!(on));
});})(on))
], null)], null);
});
avalon.pages.games.start_game_BANG_ = (function avalon$pages$games$start_game_BANG_(id){
...
avalon.pages.games.refresh_game = (function avalon$pages$games$refresh_game(){
var params = reagent.session.get.call(null,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
avalon.pages.games.get_game_BANG_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(params),new cljs.core.Keyword(null,"force","force",781957286),true);

return avalon.pages.games.get_info_BANG_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(params),new cljs.core.Keyword(null,"person-id","person-id",1251942696).cljs$core$IFn$_invoke$arity$1(params));
});
avalon.pages.games.game_page = (function (){var timer = reagent.core.atom.call(null,null);
...
return (function (){
return avalon.pages.games.delete_player_BANG_.call(null,id,player);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24497),avalon$pages$games$iter__24494.call(null,cljs.core.chunk_rest.call(null,s__24495__$2)));
} else {
...
], null)], null),player], null)], null),avalon$pages$games$iter__24494.call(null,cljs.core.rest.call(null,s__24495__$2)));
}
} else {
return null;
}
...
return (function avalon$pages$games$iter__24498(s__24499){
return (new cljs.core.LazySeq(null,((function (game,map__24492,map__24492__$1,id,people,roles,error,timer){
return (function (){
...
cljs.core.chunk_append.call(null,b__24501,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.ListItem,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [avalon.pages.games.role_toggle,id,roles,role], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),role], null)));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24501),avalon$pages$games$iter__24498.call(null,cljs.core.chunk_rest.call(null,s__24499__$2)));
} else {
...
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.ListItem,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [avalon.pages.games.role_toggle,id,roles,role], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),role], null)),avalon$pages$games$iter__24498.call(null,cljs.core.rest.call(null,s__24499__$2)));
}
} else {
return null;
}
...
return (function (){
return cljs.core.reset_BANG_.call(null,timer,setInterval(avalon.pages.games.refresh_game,(5000)));
});})(timer))
