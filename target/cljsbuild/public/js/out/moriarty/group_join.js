...
goog.provide('moriarty.group_join');
...
moriarty.group_join.join_handler = (function moriarty$group_join$join_handler(response){
...
moriarty.group_join.join_error = (function moriarty$group_join$join_error(p__29677){
...
moriarty.group_join.join_group = (function moriarty$group_join$join_group(name,code){
return ajax.core.POST.call(null,"/api/groups/join",new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"code","code",1586293142),code], null),new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"json","json",1279968570),new cljs.core.Keyword(null,"response-format","response-format",1664465322),new cljs.core.Keyword(null,"json","json",1279968570),new cljs.core.Keyword(null,"keywords?","keywords?",764949733),true,new cljs.core.Keyword(null,"handler","handler",-195596612),moriarty.group_join.join_handler,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),moriarty.group_join.join_error], null));
});
moriarty.group_join.join_form = (function moriarty$group_join$join_form(){
...
return (function (){
return moriarty.group_join.join_group.call(null,new cljs.core.Keyword(null,"group-name","group-name",-232140110).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,state)),new cljs.core.Keyword(null,"group-code","group-code",538359099).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,state)));
});})(state))
